...
//           {/* 알림 메시지 개수 표시 - 미니멀 스타일 */}
//           {footerDataList.length > 0 && (
//             <div className="flex items-center py-[2px] px-[7px] bg-gray-100 rounded-md">
//               <Bell size={14} className="text-gray-500" />
//               <span className="ml-1.5 text-[12px] font-medium text-gray-600">
...
//           {/* 연결 상태 아이콘 - 연결되면 표시 */}
//           {isConnected && (
//             <span className="flex items-center text-[12px] text-green-600" title="SSE 연결됨">
