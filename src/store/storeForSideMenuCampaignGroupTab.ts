...
//         throw new Error("QueryClient not initialized. Make sure to call setQueryClientForStore() first.");
//       }

//       // Invalidate the React Query cache for this query key
//       await queryClientInstance.invalidateQueries({ 
//         queryKey: ['campaignTreeDataForCampaignGroupTab', targetTenantId]
//       });
      
//       // Note: Actual refetching will be handled by the useApiForGetTreeDataForCampaignGroupTab hook
//       // useEffect in the hook detects the cache invalidation and triggers refetch
