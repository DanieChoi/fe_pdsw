...
export const baseTabs = [
    ...
    { id: 'agent', label: '상담원', icon: '/tree-menu/ghost_icon_for_counselor_tab.png', iconWidth: 14, iconHeight: 14 },
    { id: 'agent-group', label: '캠페인 그룹', icon: '/tree-menu/campain_group.png' , iconWidth: 12, iconHeight: 12 }
  ] as const;
