...
//   // 뷰 모드에 따른 필터링 (테넌트만 또는 캠페인까지) - 수정된 버전
...
//               // 중요 변경: 자식 목록을 비우지 않고, 각 자식을 visible: false로 설정
//               // 이렇게 하면 자식이 존재하므로 +/- 버튼이 표시됨
//               return {
//                 ...child,
...
//     // 'campaign' 모드에서는 모든 노드의 visible을 true로 설정
//     return items.map(item => {
...
//     }
//   }, [isLoading, error, treeData, expandNodes, originalItems, viewMode, selectedNodeType, forceUpdate]);
