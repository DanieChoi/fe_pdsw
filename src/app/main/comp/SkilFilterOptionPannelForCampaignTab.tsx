...
//   const { data: skills, isLoading, isError } = useAssignableSkills(tenant_id);
...
//   // 선택한 스킬 콘솔 출력
//   const handleConfirm = () => {
//     console.log("✅ 선택한 스킬 목록:", selectedSkills);
//   };
...
//           ))
//         ) : (
//           <p className="text-gray-500">불러올 스킬이 없습니다.</p>
//         )}
//       </ul>

//       <div className="mt-4 flex gap-2">
//         <Button onClick={() => console.log("📢 현재 불러온 스킬 목록:", skills)}>
//           확인
//         </Button>
