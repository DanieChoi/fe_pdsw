...
const HeaderColumn : Column<SendRow>[] = [
  ...
  { key: 'CSC1', name: '고객성향[1]', width: 120 },
  { key: 'CSC2', name: '고객성향[2]', width: 120 },
  { key: 'CSC3', name: '고객성향[3]', width: 120 },
  { key: 'CSC4', name: '고객성향[4]', width: 120 },
  { key: 'CSC5', name: '고객성향[5]', width: 120 },
  { key: 'CSC6', name: '고객성향[6]', width: 120 },
  { key: 'EMPLOYEEID', name: '상담사 아이디', width: 140 },
  { key: 'TKDA', name: '토큰데이터', width: 160 },
];
